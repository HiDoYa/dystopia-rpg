...
game: main.o Textbox.o Npc.o Player.o Environment.o Mouse.o
...
Environment.o: include/Environment.h include/Environment.cpp
	g++ -std=c++11 -c include/Environment.cpp
